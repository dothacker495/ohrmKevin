...
--
-- Host: localhost
-- Generation Time: Apr 17, 2013 at 04:29 PM
...
CREATE TABLE IF NOT EXISTS `hs_hr_kpi` (
  `id` int(13) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `hs_hr_performance_review` (
  `id` int(13) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `hs_hr_performance_review_comments` (
...
(1, 1, 'pim/viewEmployeeList', NULL, 10),
(2, 2, 'pim/viewMyDetails', NULL, 0);
...
(13, 5, 2, 'time/defineTimesheetPeriod', 'TimesheetPeriodDefinedHomePageEnabler', 100),
...
(17, 9, 1, 'performance/viewReview', NULL, 20),
(18, 9, 2, 'performance/viewReview', NULL, 0);
...
(1, 1, NULL, 'Admin', '4297f44b13955235245b2497399d7a93', 0, 1, NULL, NULL, NULL, NULL);
...
-- Events
--
CREATE DEFINER=`root`@`localhost` EVENT `leave_taken_status_change` ON SCHEDULE EVERY 1 HOUR STARTS '2013-04-17 00:00:00' ON COMPLETION NOT PRESERVE ENABLE DO BEGIN
